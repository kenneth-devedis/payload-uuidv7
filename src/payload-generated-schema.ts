...
import { pgTable, index, uniqueIndex, foreignKey, uuid, timestamp, varchar, numeric, serial, integer, jsonb } from '@payloadcms/db-postgres/drizzle/pg-core'
import { sql, relations } from '@payloadcms/db-postgres/drizzle'

export const users = pgTable('users', {
  id: uuid('id').primaryKey().default([object Object]),
